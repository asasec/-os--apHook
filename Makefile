...
# Swift derleyicisini patlatmamak için C++ bayraklarını yalnızca C++ derleyicisine (ADDITIONAL_CCFLAGS) veriyoruz
ADDITIONAL_CCFLAGS = -std=c++11 -Wno-error=unused-variable -Wno-error=vla-cxx-extension -Wno-error=deprecated-declarations -I$(THEOS_PROJECT_DIR)/Sources/asasecmod/KittyMemory
